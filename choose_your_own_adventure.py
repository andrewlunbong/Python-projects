...
if answer == "left":
    answer = input("You come to a river, you can walk around ut or swim across? Type walk to walk around and swim to swim across: ")

    if answer == "swim":
        print("You swam across and were eaten by alligator.")
    elif answer == "walk":
        print("You walked for many niles, ran out of water and you lost the game")
    else:
